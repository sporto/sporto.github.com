...
I cannot end this post without adding in my personal opinion. So here it is:

### Backbone

I am not a fan of Backbone at all. I think it lacks many important features. It was a great library two years ago, but there are better things now. I believe that many people choose Backbone just because of its popularity, it is a vicious circle.

### Ember

I like the philosophy of Ember of having strong conventions. And I have a lot of respect for the core developers, Yehuda is a legend. But I find Ember to be too big, harder to learn and maintain (if you are not a heavy user). I would consider Ember again if it becomes extremely popular as Rails is in the backend world.

### CanJS

I think that CanJS strikes an amazing balance between ease of use and features. It really lets you do most of what you need to do without a huge learning investment. It has a very nice API that feel familiar for developers with a jQuery background. It is very flexible when you need it but it gives you all the right tools to be productive. I use CanJS every day and I will choose it for new projects.

### Angular

I think that Angular is an amazing piece of engineering, I like the declarative html, using plain javascript objects as observable objects, two way bindings and the dependency injection. But Angular does require a large learning investment. I also use Angular often. I will also choose Angular for new projects.

Between CanJS and Angular I have a hard time deciding what to use.
